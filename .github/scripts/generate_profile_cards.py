...
<g font-family="Segoe UI,Ubuntu,Arial,sans-serif">{text(24,34,title,18,palette['title'],'600')}{contents}</g></svg>'''
    ...
    (OUT/f'stats-equal{suffix}.svg').write_text(card(420,190,'Public GitHub Stats',rows),encoding='utf-8')
    ...
    (OUT/f'languages-equal{suffix}.svg').write_text(card(420,190,'Code Languages',body),encoding='utf-8')
